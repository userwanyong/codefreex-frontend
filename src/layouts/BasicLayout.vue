      ...
      <div class="nav-container">
        ...
        <div class="nav-right">
          <a-popover placement="bottomRight" trigger="click">
            <template #content>
              <div class="github-popover">
                <a href="https://github.com/userwanyong/codefreex-frontend" target="_blank" rel="noopener noreferrer" class="github-link">
                ...
                <a href="https://github.com/userwanyong/codefreex" target="_blank" rel="noopener noreferrer" class="github-link">
            ...
            <button class="theme-toggle" title="GitHub">
